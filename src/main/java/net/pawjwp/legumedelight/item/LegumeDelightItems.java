...
public class LegumeDelightItems {
    public static LinkedHashSet<Supplier<Item>> CREATIVE_TAB_ITEMS = new LinkedHashSet<>();

    public static final DeferredRegister<Item> ITEMS =
            DeferredRegister.create(Registries.ITEM, LegumeDelight.MOD_ID);
    ...
    // Wild Crops
    public static final Supplier<Item> WILD_BEANS = registerWithTab("wild_beans",
    ...
    public static final Supplier<Item> REFRIED_BEANS = registerWithTab("refried_beans",
    ...
    // Sweets
    public static final Supplier<Item> CANDIED_PEANUTS = registerWithTab("candied_peanuts",
            () -> new Item(foodItem(LegumeDelightFoodValues.CANDIED_PEANUTS)));
    public static final Supplier<Item> MOONCAKE = registerWithTab("mooncake",
            () -> new Item(foodItem(FoodValues.PIE_SLICE)));
    public static final Supplier<Item> PEANUT_BAR = registerWithTab("peanut_bar",
    ...
    public static final Supplier<Item> PEANUT_BUTTER_CUP = registerWithTab("peanut_butter_cup",
            () -> new Item(foodItem(FoodValues.COOKIES)));
    public static final Supplier<Item> RICE_CAKE = registerWithTab("rice_cake",
            () -> new Item(foodItem(FoodValues.PIE_SLICE)));
    public static final Supplier<Item> TRAIL_MIX = registerWithTab("trail_mix",
            () -> new Item(foodItem(LegumeDelightFoodValues.TRAIL_MIX)));

    // Handheld Foods
    public static final Supplier<Item> BEAN_BURGER = registerWithTab("bean_burger",
            () -> new Item(foodItem(LegumeDelightFoodValues.BEAN_BURGER)));
    public static final Supplier<Item> BEAN_BURRITO = registerWithTab("bean_burrito",
            () -> new Item(foodItem(LegumeDelightFoodValues.BEAN_BURRITO)));
    public static final Supplier<Item> BEANS_ON_TOAST = registerWithTab("beans_on_toast",
            () -> new Item(foodItem(LegumeDelightFoodValues.BEANS_ON_TOAST)));
    /*public static final Supplier<Item> NACHOS = registerWithTab("nachos",
            () -> new Item(foodItem(LegumeDelightFoodValues.NACHOS)));*/
    public static final Supplier<Item> PEANUT_BUTTER_AND_JAM_SANDWICH = registerWithTab("peanut_butter_and_jam_sandwich",
            () -> new Item(foodItem(LegumeDelightFoodValues.PEANUT_BUTTER_AND_JAM_SANDWICH)));
    /*public static final Supplier<Item> POTATO_TACO = registerWithTab("potato_taco",
            () -> new Item(foodItem(LegumeDelightFoodValues.POTATO_TACO)));*/

    // Bowl Foods
    public static final Supplier<Item> BAKED_BEANS = registerWithTab("baked_beans",
            () -> new ConsumableItem(bowlFoodItem(LegumeDelightFoodValues.BAKED_BEANS), true));
    public static final Supplier<Item> BEANS_AND_RICE = registerWithTab("beans_and_rice",
            () -> new ConsumableItem(bowlFoodItem(LegumeDelightFoodValues.BEANS_AND_RICE), true));
    public static final Supplier<Item> CHILI = registerWithTab("chili",
            () -> new ConsumableItem(bowlFoodItem(LegumeDelightFoodValues.CHILI), true));
    public static final Supplier<Item> PAD_THAI = registerWithTab("pad_thai",
            () -> new ConsumableItem(bowlFoodItem(LegumeDelightFoodValues.PAD_THAI), true));

    // Plated Foods
    public static final Supplier<Item> PASTA_WITH_TOMATO_SAUCE = registerWithTab("pasta_with_tomato_sauce",
